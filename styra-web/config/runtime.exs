...
#
#     PHX_SERVER=true bin/styra_web start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :styra_web, StyraWebWeb.Endpoint, server: true
end
  ...
  config :styra_web, StyraWebWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/styra_web_web/router\.ex$"E,
        ~r"lib/styra_web_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :styra_web, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

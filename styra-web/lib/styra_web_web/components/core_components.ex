defmodule StyraWebWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StyraWebWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StyraWebWeb.Gettext, "errors", msg, opts)
    end
  end

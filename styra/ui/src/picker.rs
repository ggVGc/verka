...
fn session_tree_depths(sessions: &[SessionSummary]) -> Vec<usize> {
...
fn render_sessions_preview(
    ...
    let title = match workspace {
        Some(workspace) => format!(" sessions \u{b7} {} ", workspace_display_name(workspace)),
